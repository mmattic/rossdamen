...
var BLANK_GIF = makePath("blank.gif"/*tpa=https://io.vtex.com.br/checkout-ui/5.16.7/lib/ie-responsive/blank.gif*/, path);
...
function ie7Quirks() {
  ...
  for (var i = 0; i < FONT_SIZES.length; i++) {
    FONT_SIZES[FONT_SIZES[i]] = FONT_SIZES[i - 1] || "https://io.vtex.com.br/checkout-ui/5.16.7/lib/ie-responsive/0.67em";
  }
...
(function() {
  ...
  if (typeof IE7_PNG_SUFFIX == "object") {
    ...
    PNG = new RegExp(rescape(window.IE7_PNG_SUFFIX || "-trans.png"/*tpa=https://io.vtex.com.br/checkout-ui/5.16.7/lib/ie-responsive/-trans.png*/) + "(\\?.*)?$", "i");
  }
